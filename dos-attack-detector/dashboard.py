...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.activealerts_lbl.setGeometry(QRect(300, 90, 279, 60))
        self.activealerts_lbl.setMaximumSize(QSize(1000, 60))
        self.activealerts_lbl.setFont(font1)
        self.label_8 = QLabel(self.centralwidget)
        self.label_8.setObjectName(u"label_8")
        self.label_8.setGeometry(QRect(300, 150, 441, 60))
        self.label_8.setMaximumSize(QSize(1000, 60))
        self.label_8.setFont(font1)
        self.label_9 = QLabel(self.centralwidget)
        self.label_9.setObjectName(u"label_9")
        self.label_9.setGeometry(QRect(300, 280, 441, 60))
        self.label_9.setMaximumSize(QSize(1000, 60))
        self.label_9.setFont(font1)
        self.gridLayoutWidget = QWidget(self.centralwidget)
        self.gridLayoutWidget.setObjectName(u"gridLayoutWidget")
        self.gridLayoutWidget.setGeometry(QRect(300, 210, 451, 80))
        ...
        self.protocolslist_lbl = QLabel(self.centralwidget)
        self.protocolslist_lbl.setObjectName(u"protocolslist_lbl")
        self.protocolslist_lbl.setGeometry(QRect(300, 340, 441, 101))
        self.protocolslist_lbl.setWordWrap(True)
        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QMenuBar(MainWindow)
        self.menubar.setObjectName(u"menubar")
        self.menubar.setGeometry(QRect(0, 0, 762, 25))
        self.menuDashboard = QMenu(self.menubar)
        self.menuDashboard.setObjectName(u"menuDashboard")
        self.menuMonitor_control = QMenu(self.menubar)
        self.menuMonitor_control.setObjectName(u"menuMonitor_control")
        ...
        self.menubar.addAction(self.menuMonitor_control.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_9.setText(QCoreApplication.translate("MainWindow", u"Top protocol distributions", None))
        ...
        self.protocolslist_lbl.setText(QCoreApplication.translate("MainWindow", u"...", None))
        self.menuDashboard.setTitle(QCoreApplication.translate("MainWindow", u"Dashboard", None))
        self.menuMonitor_control.setTitle(QCoreApplication.translate("MainWindow", u"Monitor control", None))
